...
int main(int argc, char* argv[])
{
    ...
    using mtx = gko::matrix::Coo<std::complex<double>, IndexType>;
...
// @sect3{Where do you want to run your solver ?}
    ...
    // to use.
            ...
            std::cout << "Read B\n";
            auto b = gko::read<mtx>(std::ifstream("../data/b.mtx"), exec);
            std::cout << "Read x0\n";
            auto x = gko::read<mtx>(std::ifstream("../data/x0.mtx"), exec);
            std::cout << "All Read\n";
