...
vtk_filepath='/home/exouser/FEFD_Prototype/Mesh_Files/final_mesh_Xushan.vtk' 
...
cond_mu_filepath='/home/exouser/FEFD_Prototype/Input_Models/Halfspace_001_final_mesh_Xushan.npy' 
...
txseg_filepath='/home/exouser/FEFD_Prototype/Tx_Rx_Files/TxSegFiles/final_mesh_Xushan_txsegs.csv'
...
rxcoord_folder='/home/exouser/FEFD_Prototype/Tx_Rx_Files/'
rxcoord_filename='rxpts1cm_up_final_mesh_Xushan' # Don't put .csv or extension name.
xyzcolnames=['x (m)','y (m)','z (m)']

# Folder containing Tetra indices for receiver locations. 
# Must have run the data prep code Parallelized_Create_and_Prep_Data_for_FEFD.py or Create_and_Prep_Data_for_FEFD.py scripts first.
rxtet_folder='/home/exouser/FEFD_Prototype/Tx_Rx_Files/RxTetraFiles/'
...
export_filepath='/home/exouser/FEFD_Prototype/Output_Data/loopsrc_Halfspace_0p001_f300000_final_mesh_Xushan.csv'
